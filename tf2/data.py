...
def gen_train_batch_bg(dsfn, mb_size, in_depth):
    ...
    dsfn : str  数据集文件名
    mb_size: 生成的batch大小
    in_depth: 代表batch的维度，默认为1，即代表2D数据
    """
    ...
    while True:
        ...
        batch_X = np.transpose(batch_X, [1,2,3,0]) # batch_X->(2,1024,256,mb_size)
